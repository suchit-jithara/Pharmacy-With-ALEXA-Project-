                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" type="text" id="fullname" placeholder="First name" required>
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="form-group">
                                                <label for="fullname">Last Name</label>
                                                <input class="form-control" type="text" id="username" placeholder="Last name" required>
                                            </div>
                                        </div>
                                    </div>
