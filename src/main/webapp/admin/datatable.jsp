...
<head>
    ...
    <link rel="stylesheet" href="adminResources/css/responsive.bootstrap4.css">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-12 box-margin">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="card-title mb-2">Basic Data Table</h4>
                                            <p class="text-muted font-14 mb-4">
                            ...
                            <div class="row">
                                <div class="col-12 box-margin">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="card-title mb-2">Multi item selection</h4>
                                            <p class="text-muted font-14 mb-4">
                            ...
                            <div class="row">
                                <div class="col-12 box-margin">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="card-title mb-2">Scroll - Vertical</h4>
                            ...
                            <div class="row">
                                <div class="col-12 box-margin">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="card-title mb-2">Scroll - Horizontal</h4>
                                            <p class="text-muted font-13 mb-4">
                            ...
                            <div class="row">
                                <div class="col-12 box-margin">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="card-title mb-2">Row Created Callback</h4>
                                            <p class="text-muted font-13 mb-4">
                            ...
                            <div class="row">
                                <div class="col-12 box-margin">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="card-title mb-2">State Saving</h4>
                                            <p class="text-muted font-13 mb-4">
